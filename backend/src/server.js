...
import launchRouter from "./routes/launch.js";           // ADDED: launch/logo route
...
app.use("/api/launch", launchRouter);                    // ADDED: launch/logo route

// ADDED: serve hosted token logos + metadata so wallets/explorers can read them
